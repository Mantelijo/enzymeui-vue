                        ...
                        <div class="ml-auto d-flex flex-row justify-content-end align-items-center">
                            ...
                            <div class="cursor-pointer position-relative ">
                                <Dropdown>
                                    <template #button>
                                        ...
                                        <Badge pill class="font-size-50 position-absolute" style="top:0;right: 0;">5
                                        </Badge>
                                    </template>
                                    <div class="dropdown-item ">
                                        <div>
                            ...
                            <div class="ml-4">
                                <Dropdown class="">
                                    ...
                                    <div class="account-dropdown-item d-flex align-items-center p-2">
                                        ...
                                        <div class="ml-3 color-gray-600">
                                            Settings
                                        </div>
                                    </div>
                                    <div class="account-dropdown-item d-flex align-items-center p-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="stroke-danger" width="20"
                                             height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#4CAF50"
                                             fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z"/>
